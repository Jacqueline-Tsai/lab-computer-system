...
-- Concurrent version runs the four copy chains in parallel.
...
check(disk.format("disks/C02-copychain.sfs", N_BLOCKS))
...
lanes[1] = lane_copy("small", 20)
lanes[2] = lane_copy("medium", 20)
lanes[3] = lane_copy("large", 20)
lanes[4] = lane_copy("huge", 20)
